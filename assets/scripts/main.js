...
function initializeServiceWorker() {
  ...
  if ("serviceWorker" in navigator) {
    ...
    window.addEventListener('load', function() {
      ...
      try {
        const reg = this.navigator.serviceWorker.register('./sw.js');
        ...
        console.error("Fail to register service worker", error.message);
      }
...
async function getRecipes() {
  ...
  let storedRec = localStorage.getItem('recipes');
  if(storedRec !== null) {
    console.log('store')
    return JSON.parse(storedRec);
  }
  /**************************/
